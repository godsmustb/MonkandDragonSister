...
await click('1 PLAYER'); await p.waitForTimeout(500);
await click('GLACIAL'); await p.waitForTimeout(1200);
await p.screenshot({ path: 'shots/launch/charselect-glacial.png' });
